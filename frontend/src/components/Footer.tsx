      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold mb-4">Learning Management System</h3>
            <p className="text-gray-300 text-sm leading-relaxed">
              Empowering learners worldwide with quality education and innovative learning experiences.
              Join our community of students and instructors today.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/courses" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">
                  Courses
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/help" className="text-gray-300 hover:text-white text-sm transition-colors duration-200">
                  Help Center
                </a>
              </li>
              <li>
